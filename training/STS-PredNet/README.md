...
Use the shared chunk runner instead of the standalone script when you want integrate-branch outputs:
...
Integrated outputs are written to `training/results/STS-PredNet/` with metrics tables, per-chunk timing logs, `report.txt`, and `checkpoints/`.
