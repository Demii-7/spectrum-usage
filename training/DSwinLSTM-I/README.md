...
The first integrated pass uses shared CSV chunk data reshaped into a pseudo-map. Run it with:
...
Integrated outputs are written to `training/results/DSwinLSTM-I/` with metrics tables, per-chunk timing logs, `report.txt`, and `checkpoints/`.
