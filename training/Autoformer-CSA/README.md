...
Use the integrated runner for the shared chunk pipeline:
...
Integrated outputs are written to `training/results/Autoformer-CSA/` with metrics tables, per-chunk timing logs, `report.txt`, and `checkpoints/`.
