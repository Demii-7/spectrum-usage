...
Use the integrated chunk runner when you want shared `integrate`-branch outputs:
...
Integrated outputs are written to `training/results/VanillaLSTM/` with metrics tables, per-chunk timing logs, `report.txt`, and `checkpoints/`.
