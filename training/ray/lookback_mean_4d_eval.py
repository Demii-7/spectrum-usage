"""Train and evaluate the parameter-free LookbackMean4D baseline on map data."""
...
def launch(args: argparse.Namespace) -> None:
    ...
    tuner = tune.Tuner(
        ...
        run_config=RunConfig(name=f"{MODEL_NAME}-eval", storage_path=args.storage_path),
    )
    results = tuner.fit()
