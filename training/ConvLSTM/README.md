...
Use the branch-wide runner for chunk-based AERPAW training:
...
Integrated outputs are written to `training/results/ConvLSTM/` with metrics, per-chunk training logs, `report.txt`, and `checkpoints/`.
